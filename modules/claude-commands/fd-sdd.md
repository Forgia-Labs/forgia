...
5. Read the dev-guide from `.forgia/dev-guide/`
6. For each component listed in "SDD Previsti" in the FD, create an SDD:
   ...
   - Populate each SDD with:
     ...
     - **Best Practices**: from dev-guide + constitution
